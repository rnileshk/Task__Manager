...
export const moon = <i className="fa-solid fa-mooon"></i>;
...
export const users = <i className="fa-solid fa-user-plus"></i>;
...
export const linked = <i className="fa-solid fa-linkedin"></i>;
...
export const inProgress = <i className="fa-solid fa-check"></i>;